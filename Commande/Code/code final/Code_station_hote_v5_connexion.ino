...
void loop() {
  if (!loopExecuted){ 
    ...
    motorForward();
    setMotorSpeeds(250, 255);  // Vitesse pour moteur A et moteur B respectivement
    delay(220);               // Maintient la vitesse pendant 5 secondes
